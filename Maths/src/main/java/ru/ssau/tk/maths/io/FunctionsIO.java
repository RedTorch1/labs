package ru.ssau.tk.maths.io;

import ru.ssau.tk.maths.functions.*;
import java.io.*;

import ru.ssau.tk.maths.functions.Point;
...
public final class FunctionsIO {
    ...
    public static List<TabulatedFunction> loadAll() {
        List<TabulatedFunction> functions = new ArrayList<>();
        // TODO: загрузка из файлов
        return functions;
    }
